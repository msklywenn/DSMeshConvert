...
// Constructor
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CustomArray::CustomArray(unsigned long startsize, void* inputbuffer) : mNbPushedAddies(0), mNbAllocatedAddies(0), mBitCount(0), mBitMask(0), mAddresses(0), mCollapsed(0)
{
...
// Constructor
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CustomArray::CustomArray(const char* filename) : mNbPushedAddies(0), mNbAllocatedAddies(0), mBitCount(0), mBitMask(0), mAddresses(0), mCollapsed(0)
{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Input	:	previouscell	= the previous cell, or 0 if this is the first
//				size			= #bytes to allocate for the first cell
// Output	:	-
// Return	:	self-reference
// Exception:	-
// Remark	:	'size' is only used if previouscell is 0 (i.e. for the first cell)
CustomArray& CustomArray::NewBlock(CustomCell* previouscell, unsigned long size)
{
	...
	Cell->Item.Addy = (void*)new u8[Cell->Item.Max];
	Cell->Item.Size = 0;
...
void* CustomArray::Collapse(void* userbuffer)
{
	...
	if(!userbuffer)
	{
		...
		mCollapsed = CurrentSize ? new u8[CurrentSize] : 0;
...
bool CustomArray::PushAddress()
{
	...
	if((mNbPushedAddies+1)>mNbAllocatedAddies)
	{
		...
		u32 NewSize = mNbAllocatedAddies ? mNbAllocatedAddies * 2 : 1;
...
// Output	:	-
// Return	:	u32	= size in bytes, or 0 if file doesn't exist
// Exception:	-
// Remark	:	-
#ifndef SEEK_END
#define SEEK_END 2
#endif
u32 CustomArray::FileSize(const char* name)
{
	FILE* File = fopen(name, "rb");
	if (!File) return 0;
	fseek(File, 0, SEEK_END);
	u32 eof_ftell = ftell(File);
	fclose(File);
	return eof_ftell;
}
